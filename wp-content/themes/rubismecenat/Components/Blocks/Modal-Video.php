...
<article class="modal-video">
    <div class="grid">
        ...
        <div class="m-5col">
            ...
            <a href="<?php the_permalink(); ?>" data-slug="<?php echo get_post_field( 'post_name', get_post() );?>" class=" -block flex gap-s -center-y btn -simple -hover-gray">
                <span class="btn -round -white -clean -medium"><?php get_template_part( 'Components/Svgs/Svg', 'Plus' ); ?></span>
