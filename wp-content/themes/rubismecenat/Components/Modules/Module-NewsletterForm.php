                ...
                <div class="entry__field" style="background: none; border: none; border-bottom: 1px solid #9B9B9B;">
                  ...
                  <div>
                    <div class="sib-form-block" style="text-align: left">
                      <button class="sib-form-block__button sib-form-block__button-with-loader" style=" text-align:left; color:#FFFFFF; background: none; border-width:0px;" form="sib-form" type="submit" aria-label="je m'inscris à la newsletter Rubis Mécénat">
