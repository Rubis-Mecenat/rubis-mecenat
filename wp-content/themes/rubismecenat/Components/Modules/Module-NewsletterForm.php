...
<div class="sib-form" style="text-align: right;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--horizontal" style="max-width:540px; text-align:right; background-color:transparent; border-width:0px; border-style:solid; border-color:#C0CCD9; direction:ltr">
      <form id="sib-form" method="POST" action="https://299e5943.sibforms.com/serve/MUIFAFNscaJILdvCZzBbSYkgR9vmlPHyfKVZvpGVVfbTPevhmkZlCUkv3l0P3bby_N9Fv3Sr_Z9_8th_TSMn3dGcJk5OEgOxJWsoCJqjeenobo3nuLqaE0X0-4CAUfXKboFj505S6NYsY-6_whx_LJhR4dRAxHfMj931oBmfK5dzOuLzRxdliUIuKIZ00qVK0EXR1PU2P7v6zpjr" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          ...
          <div class="sib-form-block" style="font-family:Helvetica, sans-serif; font-size:16px; text-align:left; color:#3C4858; background-color:transparent; text-align:left">
            <div class="sib-text-form-block">
              <p><strong>Inscrivez-vous à notre newsletter pour suivre nos actualités.</strong></p>
            </div>
          </div>
            ...
            <div class="form__entry entry_block">
              <div class="form__label-row  form__label-row--horizontal ">
                ...
                <div class="entry__field">
                  ...
                  <input class="input " type="text" id="EMAIL" name="EMAIL" autocomplete="off" value="" placeholder="abc@xyz.com" data-required="true" required />
        ...
        <div style="padding: 8px 0;">
          ...
          <div class="sib-form-block" style="text-align: left">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-family:Helvetica, sans-serif; font-size:14px; text-align:left; color:#FFFFFF; background-color:#3E4857; border-width:0px; border-radius:3px;" form="sib-form" type="submit">
          ...
          <div class="sib-captcha sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row  form__label-row--horizontal ">
                ...
                <div class="g-recaptcha sib-visible-recaptcha" id="sib-captcha" data-sitekey="6LeIpcItAAAAANdL-15rk_Oi_cJ6nwoZT26ClUpC" data-callback="handleCaptchaResponse" style="direction:ltr"></div>
              </div>
              <label class="entry__error entry__error--primary" style="font-family:Helvetica, sans-serif; font-size:16px; text-align:left; color:#661d1d; background-color:#ffeded; border-color:#ff4949; border-radius:3px;">
              </label>
