<?php
/*
 * Template Name: Portfolio - Classic - 1 Column
 *
...
<div class = "portfolio portfolio-1">
	<nav class = "sticky-nav">
		<a href = "#" class = "prev" title = "<?php _e('Previous Project' , TS_DOMAIN); ?>"><?php _e('Previous Project' , TS_DOMAIN); ?></a>
		<a href = "#" class = "next" title = "<?php _e('Next Project' , TS_DOMAIN); ?>"><?php _e('Next Project' , TS_DOMAIN); ?></a>
	</nav>
<?php
$post_ID = get_the_ID();
...
while($projects->have_posts()){
	$projects->the_post();
	?>
	<article class = "entry has-divider">
		<div class = "row">
			<div class = "span-8">
			...
			<div class = "span-4">
				...
				<h2 class = "entry-title">
					...
					<? endif; ?>
						...
						$subtitle = ts_get_meta('ts_project_subtitle' , get_the_ID());
						if($subtitle){
