...
class ts_dailymotion_video extends WP_Widget{

    function ts_dailymotion_video(){
        $widget_ops = array('description' => __("Displays a DailyMotion video." , TS_DOMAIN));
        $control_ops = array('id_base' => 'ts-dailymotion-video');
        $this->WP_Widget('ts-dailymotion-video' , __('Simplex - DailyMotion Video' , TS_DOMAIN) , $widget_ops , $control_ops);
    }
    ...
    function form($instance){
        global $theme;
        $defaults = array(
          'title' => __('DailyMotion Video' , TS_DOMAIN) ,
          'intro' => '' ,
          'outro' => '' ,
          'video_id' => '' ,
          'autoplay' => 'false' ,
...
<?php
    ...
    function widget($args , $instance){
       extract($args);
        ...
        $widget_content .= '<div class = "dailymotion-video-widget">';
        $widget_content .= ts_formatter(do_shortcode('[dailymotion video_id = "' . $instance['video_id'] . '" autoplay = "' . $instance['autoplay'] . '"]'));
        $widget_content .= "</div>";
...
register_widget('ts_dailymotion_video');
?>