...
class ts_popular_posts extends WP_Widget{

	function ts_popular_posts(){
		$widget_ops = array('description' => __("Displays a list of popular posts on your site." , TS_DOMAIN));
		$control_ops = array('id_base' => 'ts-popular-posts');
		$this->WP_Widget('ts-popular-posts' , __('Simplex - Popular Posts' , TS_DOMAIN) , $widget_ops , $control_ops);
	}
	...
	function form($instance){
		global $theme;
		$defaults = array(
		  'title' => __('Popular Posts' , TS_DOMAIN) ,
		  'intro' => '' ,
		  'outro' => '' ,
		  'count' => '3' ,
		  'show_image' => 'true' ,
...
<?php
	...
	function widget($args , $instance){
		...
		$widget_content .= '<div class = "popular-posts-widget">';
		$widget_content .= ts_formatter(do_shortcode("[popular_posts count = '" . $instance['count'] . "' show_image = '" . $instance['show_image'] . "' show_title = '" . $instance['show_title'] . "' show_author = '" . $instance['show_author'] . "' show_date = '" . $instance['show_date'] . "' show_comments_count = '" . $instance['show_comments_count'] . "']"));
...
register_widget('ts_popular_posts');
?>